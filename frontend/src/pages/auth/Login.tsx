        ...
        <div className="glossy-card rounded-2xl p-4 sm:p-6 md:p-8 glossy-purple-accent relative overflow-hidden border border-white/5 backdrop-blur-xl">
          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            >
              ...
              <p className="text-gray-400 mt-2 sm:mt-3 text-base sm:text-lg">Sign in to your account</p>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <motion.div
                ...
                className="flex flex-col sm:flex-row items-start sm:items-center justify-start sm:justify-between gap-3 sm:gap-0"
              >
                <div className="flex items-center">
                  <input
                    type="checkbox"
                    className="h-3 w-3 sm:h-4 sm:w-4 text-primary-500 focus:ring-primary-500 border-gray-600 rounded bg-white/5"
                  />
                  <label className="ml-2 block text-xs sm:text-sm text-gray-300">
                    Remember me
                  </label>
                </div>
                <a href="#" className="text-xs sm:text-sm text-primary-400 hover:text-primary-300 font-medium transition-colors">
                  Forgot password?
                </a>
              </motion.div>
